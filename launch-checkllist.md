...
Launching String Authority with solid technical hygiene and AI-friendly signals is a good idea. Here’s a concise checklist you can follow.
...
- robots.txt  
  ...
  - Include sitemap location, for example:  
    - `Sitemap: https://stringauthority.com/sitemap.xml`[3]
...
- llms.txt  
  - Place at: `https://stringauthority.com/llms.txt`.[4][5]
...
- `<title>`  
  ...
  - Example hub title: `String Authority – Historic Guitars, Stories, and Provenance`.[9][1]

- `<meta name="description">`  
  - 1–2 sentence, human-readable summary mentioning audience and purpose.  
  - Example: `String Authority is a high-signal guide to historic guitars, collections, and provenance for collectors, builders, and the guitar industry.`[1]

- Canonical tag  
  - `<link rel="canonical" href="https://stringauthority.com/this-page-url/">` on each page, pointing to itself (or the canonical version if you ever cross-post).[3][1]
...
- Organization / Website schema on the site  
  - Mark up String Authority as an Organization or WebSite with name, URL, and (optionally) sameAs links to your other properties and profiles.[3][1]

- Person schema on your personal/author page  
  - Mark up yourself (on guitarhistorian.com or an “About Mariano” page) with Person schema, linking to String Authority as a “knowsAbout” or related site.[2][1]
...
- Search Console / indexing  
  - Add String Authority to Google Search Console and Bing Webmaster Tools.[11][3]
...
- AI visibility checks (ongoing)  
  - Periodically ask major assistants/engines questions like “What is String Authority?” or “Where can I learn about guitar provenance?” and see if/when you start appearing.[10][9]
...
- Add a footer that appears on all pages with:
  - © 2025 String Authority. All rights reserved.
